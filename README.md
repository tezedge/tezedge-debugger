...
- [The TezEdge Debugger](#the-tezedge-debugger)
  * [Memory Profiler](#memory-profiler)
    + [How it works](#how-it-works)
      - [1. EBPF loader](#1-ebpf-loader)
      - [2. TezEdge memprof binary](#2-tezedge-memprof-binary)
  ...
  * [Network Recorder](#network-recorder)
    + [Peer to peer messages](#peer-to-peer-messages)
      ...
      - [Encryption](#encryption)
        * [Tezos "handshake"](#tezos--handshake-)
    + [Node Logs](#node-logs)
    + [Storage](#storage)
  ...
  * [Build from sources](#build-from-sources)
    ...
    + [Rust](#rust)
    + [BPF linker (needed only for memory profiler)](#bpf-linker--needed-only-for-memory-profiler-)
    + [Kernel sources (needed only for network recorder)](#kernel-sources--needed-only-for-network-recorder-)
    + [Build](#build)
